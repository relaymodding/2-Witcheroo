...
public class HostileFamiliarBehaviour implements FamiliarBehaviour {
    ...
    public void registerGoals(PathfinderMob target, Player owner) {
        ...
        target.targetSelector.addGoal(3, new NearestAttackableTargetGoal<>(target, Mob.class, 5, false, false, (enemy) -> {
            return enemy instanceof Enemy && !(enemy instanceof Creeper);
         }));
    ...
    public String toString() {
        return "HostileFamiliarBehaviour{}";
    }
}
